...
public class CodeGuesser {
    ...
    private final static String[][] FILENAME_EXTENSION_ARRAY = {
            ...
            { "Lisp", "lisp", "lisp", "lsp", "el", "cl", "jl", "L", "emacs",
                    "sawfishrc" },
            { "Bash", "bash", "bash", "sh" },
            { "Ini", "ini", "ini" },
            ...
            { "Erlang", "erlang", "erl", "hrl", "yaws" }, { "R", "r", "r" },
            { "ActionScript", "actionscript", "as" },
            { "VBScript", "vbscript", "vbs", "vbe", "wsc" },
            { "Django Templates", "django" }, { "Http", "http" },
            { "Apache", "apache" }, { "Nginx", "nginx" }, { "CMake", "cmake" },
            { "Axapta", "axapta" }, { "1C", "1c" },
            { "AVR Assembler", "avrasm" }, { "VHDL", "vhdl" },
            { "Parser 3", "parser3" }, { "BrainFuck", "brainfuck" },
            { "Rust", "rust" }, { "Matlab", "matlab" }, { "GLSL", "glsl" },
            { "MEL", "mel" }, { "RSL", "rsl" }, { "RIB", "rib" }, };
